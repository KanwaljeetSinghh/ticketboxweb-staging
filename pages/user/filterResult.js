...
export default function FilterResult(){
    ...
    const fetchData = (query) => {
        ...
        setLoading(true)
        if(obj.hasOwnProperty("city")){
        fetch(process.env.URL+"/user/event/list?"+query, requestOptions)
    ...
    return (
        <div className="container">
            <div className="d-flex d-align-center">
                <Link href="/user/filters"><a className="cursor-pointer mr-3">
            ...
            <div className="d-flex d-flex-wrap gap-4 mb-75 mt-2">
                ...
                {obj.hasOwnProperty("minPrice") && <div className="d-flex gap-4 p-1-h pl-2 pr-2 bg-white rounded border d-align-center" >
                    <span className="f-600 font-16 l-24 text-grey d-align-center">{currency == "USD"?"$":"TTD"} &nbsp; {obj.minPrice} {obj.hasOwnProperty("minPrice") && "-"} {obj.maxPrice}</span>
